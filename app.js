...
var index = require('./routes/index'),
    ...
    forgot = require('./routes/forgotPassword'),
    u = require('./routes/u'),
    reset = require('./routes/resetPassword'),
    confirmAccount = require('./routes/confirmAccount'),
    logout = require('./routes/logout'),
    upload = require('./routes/uploadImage'),
    like = require('./routes/likes'),
    block = require('./routes/blockUser'),
    report = require('./routes/reportFake'),
    loc = require('./routes/geoloc'),
